document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        en: { "actions": "Actions", "add_missionary": "Add Missionary", "add_new_exception": "Add New Exception", "area": "Area", "assign_city_exceptions": "Assign City Exceptions", "assign_city_exceptions_desc": "Assign areas or districts to a city.", "city": "City", "danger_zone": "Danger Zone", "date_of_travel": "Date", "delete_all_travel_data": "Delete All Travel Data", "delete_confirmation": "Are you sure you want to delete all missionary travel data? This cannot be undone.", "departure_time": "Time", "destination_area": "Area", "destination_city": "Destination", "district": "District", "download_excel": "Excel", "download_pdf": "PDF", "instructions": "Instructions", "language": "Language", "master_table": "Master Table", "missionary_transfer_logistics": "Missionary Transfer Logistics", "name": "Name", "new_transfer_board": "New Transfer Board (Excel)", "old_transfer_board": "Old Transfer Board (Excel)", "origin_city": "Origin", "process_files": "Process Files", "process_with_cities": "Continue to Transportation", "remove_confirmation": "Are you sure you want to remove this missionary?", "separate_tables": "Separate Tables", "settings": "Settings", "transportation": "Transport", "travel_leader": "Leader", "type": "Type", "upload_transfer_boards": "Upload Transfer Boards", "Bus": "Bus", "Airplane": "Airplane", "Chapa": "Chapa", "Txopela/Taxi": "Txopela/Taxi", "Ride": "Ride", "Boleia": "Boleia" },
        pt: { "actions": "Ações", "add_missionary": "Adicionar Missionário", "add_new_exception": "Adicionar Nova Exceção", "area": "Área", "assign_city_exceptions": "Atribuir Exceções de Cidade", "assign_city_exceptions_desc": "Atribua áreas ou distritos a uma cidade.", "city": "Cidade", "danger_zone": "Zona de Perigo", "date_of_travel": "Data", "delete_all_travel_data": "Apagar Todos os Dados", "delete_confirmation": "Tem certeza que quer apagar todos os dados? Esta ação não pode ser desfeita.", "departure_time": "Hora", "destination_area": "Área", "destination_city": "Destino", "district": "Distrito", "download_excel": "Excel", "download_pdf": "PDF", "instructions": "Instruções", "language": "Idioma", "master_table": "Tabela Principal", "missionary_transfer_logistics": "Logística de Transferência de Missionários", "name": "Nome", "new_transfer_board": "Planilha Nova (Excel)", "old_transfer_board": "Planilha Antiga (Excel)", "origin_city": "Origem", "process_files": "Processar Arquivos", "process_with_cities": "Continuar para Transporte", "remove_confirmation": "Tem certeza que quer remover este missionário?", "separate_tables": "Tabelas Separadas", "settings": "Configurações", "transportation": "Transporte", "travel_leader": "Líder", "type": "Tipo", "upload_transfer_boards": "Carregar Planilhas", "Bus": "Autocarro", "Airplane": "Avião", "Chapa": "Chapa", "Txopela/Taxi": "Txopela/Táxi", "Ride": "Boleia", "Boleia": "Boleia" }
    };
    ...
    let appState = {
        ...
        tempData: null, transportDefaults: {}
    };
    ...
    function renderMasterTable() {
        ...
        const zones = [...new Set(appState.missionaries.map(m => m.originZone.trim().toUpperCase()))];
